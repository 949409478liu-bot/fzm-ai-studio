...
export function NodeContextMenu({ position, onDuplicate, onDisconnect, onInspect, onDelete }: NodeContextMenuProps) {
  return (
    <div className="fzm-menu fzm-floating" style={{ left: position.x, top: position.y }} role="menu">
      <button className="fzm-menu__item" type="button" disabled>Run <span>Phase 3</span></button>
      <button className="fzm-menu__item" type="button" disabled>Re-run <span>Phase 3</span></button>
